...
GO
INSERT [dbo].[NhanVien] ([MaNhanVien], [TenNhanVien], [NgaySinh], [GioiTinh], [SoDienThoai], [Email], [ChucVu], [TaiKhoan], [MatKhau], [HinhAnh], [TrangThaiHoatDong], [NgayTao], [NgayCapNhat], [DiaChi]) VALUES (N'NV001', N'Phạm Quang Duy', CAST(N'1990-02-10' AS Date), N'Nam', N'0123456789', N'phamduy@example.com', N'Quản lý kho', N'admin', N'admin', N'avatar1.jpg', 1, CAST(N'2023-05-22' AS Date), CAST(N'2023-05-22' AS Date), N'123 Đường Nguyễn Trãi, Hà Nội')
GO
...
GO
INSERT [dbo].[DonDatHang] ([MaDonDatHang], [MaNhaCungCap], [MaNhanVien], [NgayDatHang], [NgayDuKienGiao], [TrangThai], [GhiChu], [NgayTao], [TongTien]) VALUES (N'DDH001', N'NCC001', N'NV001', CAST(N'2024-11-10' AS Date), CAST(N'2024-11-15' AS Date), N'Chưa Xác Nhận', N'Đơn đặt hàng cho lô sản phẩm Giày Đông Á', CAST(N'2024-11-10' AS Date), CAST(0 AS Decimal(12, 0)))
GO
INSERT [dbo].[DonDatHang] ([MaDonDatHang], [MaNhaCungCap], [MaNhanVien], [NgayDatHang], [NgayDuKienGiao], [TrangThai], [GhiChu], [NgayTao], [TongTien]) VALUES (N'DDH002', N'NCC002', N'NV002', CAST(N'2024-11-12' AS Date), CAST(N'2024-11-18' AS Date), N'Chưa Xác Nhận', N'Đặt hàng các sản phẩm giày thể thao Việt', CAST(N'2024-11-12' AS Date), CAST(0 AS Decimal(12, 0)))
GO
INSERT [dbo].[DonDatHang] ([MaDonDatHang], [MaNhaCungCap], [MaNhanVien], [NgayDatHang], [NgayDuKienGiao], [TrangThai], [GhiChu], [NgayTao], [TongTien]) VALUES (N'DDH003', N'NCC003', N'NV003', CAST(N'2024-11-14' AS Date), CAST(N'2024-11-20' AS Date), N'Chưa Xác Nhận', N'Đơn đặt hàng bổ sung cho nhà phân phối giày quốc tế', CAST(N'2024-11-14' AS Date), CAST(0 AS Decimal(12, 0)))
GO
INSERT [dbo].[DonDatHang] ([MaDonDatHang], [MaNhaCungCap], [MaNhanVien], [NgayDatHang], [NgayDuKienGiao], [TrangThai], [GhiChu], [NgayTao], [TongTien]) VALUES (N'DDH004', N'NCC001', N'NV001', CAST(N'2024-11-15' AS Date), CAST(N'2024-11-22' AS Date), N'Chưa xác nhận', N'Nhập hàng khẩn cấp', CAST(N'2024-11-15' AS Date), CAST(0 AS Decimal(12, 0)))
GO
...
GO
INSERT [dbo].[ChiTietDonDatHang] ([MaDonDatHang], [MaSanPham], [SoLuongYeuCau], [SoLuongCungCap], [SoLuongThieu], [DonGia], [ThanhTien]) VALUES (N'DDH004', N'SP004', 20, 0, 20, CAST(2000000.00 AS Decimal(18, 2)), CAST(40000000.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[ChiTietDonDatHang] ([MaDonDatHang], [MaSanPham], [SoLuongYeuCau], [SoLuongCungCap], [SoLuongThieu], [DonGia], [ThanhTien]) VALUES (N'DDH004', N'SP008', 20, 0, 20, CAST(2500000.00 AS Decimal(18, 2)), CAST(50000000.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[ChiTietDonDatHang] ([MaDonDatHang], [MaSanPham], [SoLuongYeuCau], [SoLuongCungCap], [SoLuongThieu], [DonGia], [ThanhTien]) VALUES (N'DDH004', N'SP009', 40, 0, 40, CAST(1700000.00 AS Decimal(18, 2)), CAST(68000000.00 AS Decimal(18, 2)))
GO
